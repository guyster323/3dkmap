...
export const PT_MANIFEST: PtManifestEntry[] = [
  ...
  { path: `${PT_PATH.banners}v01-e01.png`, w: 320, h: 180, required: true },
  { path: `${PT_PATH.banners}v16-e03.png`, w: 320, h: 180, required: true },
  { path: "/assets/pixel-times/terrain/landmark-ship.png", w: 48, h: 32, required: true },
  { path: "/assets/pixel-times/terrain/landmark-army.png", w: 40, h: 28, required: true },
